...
export const G: any = {
  res: { wood: 10, food: 18, stone: 2, plank: 0, bread: 0, know: 0, silver: 5 }, foodCap: 30, happy: 70,
...
export const pay = def => Object.entries(def.cost).forEach(([r, v]: [string, number]) => G.res[r] -= v);
